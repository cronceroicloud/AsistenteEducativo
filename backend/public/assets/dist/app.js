...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Recuperar variables de configuración del backend
    const NOMBRE = window.CONFIG?.nombre || "Usuario";
    const API_URL = window.CONFIG?.apiUrl || "/api/asistente";
    ...
    function addMessage(text, sender) {
        ...
        if (sender === "bot") {
            ...
            messageDiv.innerHTML = `<div class="message-content"><p>${text}</p></div><div class="message-time">${currentTime}</div>`;
        }
